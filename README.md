...
## Results
- **PD Controller:**  
  ![Joint Angles](plots/joint_angles_pd.png)  
  Animation: `media/falling_arm_pd.mp4`

- **Place Controller (p = 0.1 vs p = 10):**  
  ![End Effector Paths](plots/end_effector_paths_p_0.1.png)  
  ![End Effector Paths](plots/end_effector_paths_p_10.png)  
...
- [Assignment 2: Place Controller Trace Circle](docs/assignment_place_trace_circle.md)
